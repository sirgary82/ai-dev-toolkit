  ...
  integrations: [
    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'What Is Context?', slug: 'context-management/what-is-context' },
            {
              ...
              slug: 'context-management/prompt-engineering-basics',
            },
            {
              label: 'The copilot-instructions.md File',
              slug: 'context-management/copilot-instructions-file',
            },
            ...
            {
              label: 'Repo Documentation for AI Tools',
              slug: 'context-management/repo-docs-for-ai',
            },
            {
              label: 'Team Agent File Management',
              slug: 'context-management/team-agent-file-management',
            },
        ...
        {
          label: 'Debugging',
          items: [{ label: 'AI-Assisted Debugging', slug: 'debugging/ai-assisted-debugging' }],
        },
        {
          label: 'Refactoring',
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Testing, Security & CI/CD (Phases 5–7)',
              slug: 'exercises/testing-and-quality',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'Backend Feature Walkthrough (.NET)',
              slug: 'case-studies/backend-feature-walkthrough',
            },
            {
              label: 'Frontend Component Walkthrough (React)',
              slug: 'case-studies/frontend-component-walkthrough',
            },
          ],
        },
        {
          label: 'Troubleshooting',
          items: [{ label: 'Common Issues & Fixes', slug: 'troubleshooting/common-issues' }],
        },
        {
          label: 'Self-Assessment',
          items: [{ label: 'Phase Checklists', slug: 'self-assessment/phase-checklists' }],
        },
        {
